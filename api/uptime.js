...
exports.config = {
    ...
    description: 'Generates an uptime canvas image',
    category: 'canvas',
    usage: ['/uptime?instag=lance.cochangco&ghub=ajirodesu&fb=Lance%20Cochangco&hours=1&minutes=23&seconds=45&botname=Wataru']
};
