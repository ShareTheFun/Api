...
exports.config = {
    ...
    description: 'Generates a welcome image using knights-canvas',
    category: 'canvas',
    usage: ['/welcome?username=Lance&avatarUrl=https://i.imgur.com/xwCoQ5H.jpeg&groupname=Ajironian&memberCount=25'],
};

exports.initialize = async function ({ req, res }) {
    try {
        // Retrieve query parameters from the request
        const { username, avatarUrl, groupname, memberCount } = req.query;
        ...
        const image = await new knights.Welcome2()
            ...
            .setBg('https://i.ibb.co/4YBNyvP/images-76.jpg') // Background image (static or can be dynamic)
